...
public class modelCarrito {
    ...
    public modelCarrito(double quantityPrice, String productId, String meauringUnit, String title, String pricerate, String image, String price, String items) {
        this.titulo = title;
        this.unidadMedida = meauringUnit;
